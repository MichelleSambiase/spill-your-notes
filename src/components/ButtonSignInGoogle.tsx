...
const ButtonSignInGoogle = ({ buttonText, isLoading, handleFunction }: IButton) => {
	return (
		<button
			type='button'
			...
			{isLoading ? <LoadingIcon stroke='gray' /> : <img src={googleIcon} alt='Ícono de Google' />}
			<p className='text-sm text-gray-600 font-medium pl-6'>{buttonText}</p>
		</button>
	)
}
