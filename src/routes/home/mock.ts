...
// export const infiniteMock: INote[] = [
// 	{
// 		title: 'Título MAESTRO',
// 		description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sed labore nostrum aperiam consectetur itaque officiis laudantium exercitationem? Explicabo magni voluptatibus obcaecati, facere id, esse recusandae rerum deserunt repellat dolores veniam officiis nesciunt doloribus praesentium eos dolore? Cum tempore necessitatibus, dolore explicabo voluptas accusantium cumque odio officiis. Optio, culpa. Officiis a nisi fugit! Nulla earum, tenetur, architecto harum saepe, omnis necessitatibus quia vel dolorem sunt repellat. Unde ratione, illo officia modi possimus veniam minus, dignissimos repudiandae ex suscipit molestiae nam! Quibusdam beatae ab cum, accusamus odio alias laudantium veniam, magni error illum ut! Illum unde voluptates temporibus praesentium voluptate, veritatis modi numquam iste dignissimos? Assumenda eaque sit atque nihil eos, iste unde commodi perferendis aliquid. Ipsam ea vero maxime maiores enim.',
// 		date: new Date(2013, 1, 19),
// 		typeOfNote: 'houseWork',
// 		id: 1
// 	},
